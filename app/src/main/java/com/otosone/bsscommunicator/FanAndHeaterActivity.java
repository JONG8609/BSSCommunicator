...
public class FanAndHeaterActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener{

    private ActivityFanAndHeaterBinding binding;
    private DrawerLayout drawer;
    private NavigationView navigationView;

    private ImageView fanAndHeaterMenuIv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fanAndHeaterMenuIv.setOnClickListener(v -> openNavigationDrawer());
    }

    private void DataBinding() {
        binding = DataBindingUtil.setContentView(this, R.layout.activity_fan_and_heater);
        drawer = binding.drawerLayout;
        navigationView = binding.navView;
        fanAndHeaterMenuIv = binding.fanAndHeaterMenuIv;
    }
